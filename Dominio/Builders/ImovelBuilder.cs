...
public class ImovelBuilder
{
    ...
    public ImovelBuilder AdicionarImagem(string url) { if(!string.IsNullOrWhiteSpace(url)) _imagensUrls.Add(url); return this; }
    ...
    public Imovel Build()
    {
        ...
        foreach (var url in _imagensUrls) 
        {
            imovel.AdicionarImagemUrl(url);
        }
        return imovel;
    }
}